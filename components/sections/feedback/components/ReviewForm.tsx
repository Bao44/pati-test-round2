...
export default function ReviewForm({ isOpen, onClose }: any) {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isOpen ? "grid-rows-[1fr] pb-10 mb-10" : "grid-rows-[0fr] border-none"
      )}
    >
        ...
        <div className="space-y-4 max-w-xl mx-auto">
          <div className="space-y-1">
            <div className="flex items-center justify-center gap-2">
              ...
              <span className="text-gray-400 text-sm max-sm:hidden">
                (5000)
              </span>
            </div>
          ...
          <div className="space-y-2">
            ...
            <label className="w-35 mx-auto flex cursor-pointer items-center justify-center border border-gray-300 py-8 hover:bg-gray-200/30">
              <Upload size={70} className=" text-gray-500" strokeWidth={2} />
              <input
                type="file"
                className="hidden"
          ...
          <div className="mx-auto max-w-xl space-y-6 text-center pt-5">
            ...
            {/* ĐIỀU KHOẢN */}
            <div>
              <p className="text-[17px] max-sm:text-[15px] leading-6 text-gray-800">
            ...
            <div className="mx-auto flex max-w-md gap-4 pt-2 max-sm:flex-col max-sm:gap-0 max-sm:max-w-43.75">
              ...
              <button
                ...
                className="flex-1 cursor-pointer bg-[#FF8B8B] py-1.5 text-lg font-bold text-white shadow-sm transition-colors hover:bg-[#ff7676]"
              >
                Submit Review
              </button>
            </div>
