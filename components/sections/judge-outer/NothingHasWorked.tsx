    ...
    <div className="mt-14 pb-18.75 bg-bg-cream max-sm:mt-2">
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="mx-auto mt-5 max-w-md space-y-4 text-center">
          <button className="w-full rounded-sm bg-black py-4 text-[19px] font-bold text-white cursor-pointer hover:bg-black/70 transition">
          ...
          <div className="flex items-center justify-center gap-4 text-sm font-medium text-gray-600">
            <img
              ...
              alt="Guarantee"
            />
            <span className="font-bold text-black text-[17px]">60 day money-back guarantee</span>
          </div>
        </div>
      </div>
    </div>
